...
const dictionaries = {
  vi: {
    ...
    "chatbot.title": "Kami",
    "chatbot.description": "Kami giúp bạn hỏi từ vựng, ngữ pháp, bài đọc và chọn bước học tiếp theo.",
    "chatbot.welcome.title": "Xin chào, mình là Kami.",
    "chatbot.welcome.description": "Mình có thể giải thích từ vựng, ngữ pháp, quiz và bài đọc bằng tiếng Việt dễ hiểu. Nếu bạn muốn kiểm tra nhanh, mình cũng có thể tạo quiz nhỏ để bạn luyện ngay.",
    "chatbot.now": "Bây giờ",
    ...
    "chatbot.suggestion.readingSummary": "Tóm tắt bài này",
    "chatbot.suggestion.readingWords": "Giải thích 5 từ khó",
    "chatbot.suggestion.readingGrammar": "Giải thích ngữ pháp trong bài",
    "chatbot.suggestion.readingQuiz": "Tạo quiz từ bài này",
    "chatbot.suggestion.readingListen": "Nghe bài đọc",
    ...
    "chatbot.sources.title": "Tài liệu liên quan",
    "chatbot.sources.recent": "Nội dung vừa dùng",
    "chatbot.sources.empty": "Chưa có tài liệu liên quan. Hãy gửi một câu hỏi cụ thể hơn.",
    "chatbot.reading.current": "Bài đang học",
    "chatbot.reading.level": "Level",
    "chatbot.reading.levelUnknown": "Chưa rõ",
    "chatbot.source.grammar": "Ngữ pháp",
    "chatbot.source.quiz": "Quiz",
    "chatbot.source.news": "Bài đọc",
    "chatbot.source.vocabulary": "Từ vựng",
    "chatbot.agent.loading": "Kami đang xem bài học phù hợp để trả lời...",
    "chatbot.agent.toolsLoading": "Kami có thể dùng từ vựng, ngữ pháp hoặc bài đọc liên quan.",
    "chatbot.provider.label": "Trạng thái",
    "chatbot.provider.ready": "Đang hỗ trợ",
    "chatbot.provider.fallback": "Trả lời cơ bản",
    "chatbot.provider.none": "Chưa hỏi",
    ...
    "chatbot.fallbackNote": "Ghi chú: Kami đang trả lời ở chế độ cơ bản, nên bạn có thể hỏi ngắn và cụ thể hơn.",
    ...
    "chatbot.action.listenReading": "Nghe bài đọc",
    "chatbot.action.saveSource": "Lưu để ôn",
    "chatbot.action.saveArticle": "Lưu bài này",
    "chatbot.action.createQuiz": "Tạo quiz",
    "chatbot.action.createQuizFromArticle": "Tạo quiz từ bài này",
    "chatbot.action.saveShort": "Lưu",
    "chatbot.action.quizShort": "Quiz",
    "chatbot.action.logActivity": "Ghi vào lịch sử",
    "chatbot.action.savedToHistory": "Đã lưu vào lịch sử học",
  ...
  en: {
    ...
    "chatbot.title": "Kami",
    "chatbot.description": "Kami helps you ask about vocabulary, grammar, readings, and your next study step.",
    "chatbot.welcome.title": "Hello, I am Kami.",
    "chatbot.welcome.description": "I can explain vocabulary, grammar, quizzes, and readings in a beginner-friendly way. If you want a quick check, I can also create a short practice quiz.",
    "chatbot.now": "Now",
    ...
    "chatbot.suggestion.readingSummary": "Summarize this article",
    "chatbot.suggestion.readingWords": "Explain 5 hard words",
    "chatbot.suggestion.readingGrammar": "Explain grammar in this article",
    "chatbot.suggestion.readingQuiz": "Create a quiz from this article",
    "chatbot.suggestion.readingListen": "Listen to the reading",
    ...
    "chatbot.sources.title": "Related materials",
    "chatbot.sources.recent": "Recently used",
    "chatbot.sources.empty": "No related material yet. Try asking a more specific question.",
    "chatbot.reading.current": "Current reading",
    "chatbot.reading.level": "Level",
    "chatbot.reading.levelUnknown": "Unknown",
    "chatbot.source.grammar": "Grammar",
    "chatbot.source.quiz": "Quiz",
    "chatbot.source.news": "Reading",
    "chatbot.source.vocabulary": "Vocabulary",
    "chatbot.agent.loading": "Kami is checking suitable lessons before answering...",
    "chatbot.agent.toolsLoading": "Kami may use related vocabulary, grammar, or reading content.",
    "chatbot.provider.label": "Status",
    "chatbot.provider.ready": "Ready",
    "chatbot.provider.fallback": "Basic answer",
    "chatbot.provider.none": "Not started",
    ...
    "chatbot.fallbackNote": "Note: Kami is answering in basic mode, so try asking a shorter and more specific question.",
    ...
    "chatbot.action.listenReading": "Listen to reading",
    "chatbot.action.saveSource": "Save to review",
    "chatbot.action.saveArticle": "Save this article",
    "chatbot.action.createQuiz": "Create quiz",
    "chatbot.action.createQuizFromArticle": "Create quiz from this article",
    "chatbot.action.saveShort": "Save",
    "chatbot.action.quizShort": "Quiz",
    "chatbot.action.logActivity": "Save to history",
    "chatbot.action.savedToHistory": "Saved to learning history",
  ...
  ja: {
    ...
    "chatbot.title": "Kami",
    "chatbot.description": "Kamiが語彙、文法、読解、次の学習をやさしくサポートします。",
    "chatbot.welcome.title": "こんにちは。Kamiです。",
    "chatbot.welcome.description": "語彙、文法、クイズ、読解を初心者向けに説明できます。確認したい時は短い練習クイズも作れます。",
    "chatbot.now": "今",
    ...
    "chatbot.suggestion.readingSummary": "この記事を要約する",
    "chatbot.suggestion.readingWords": "難しい単語を5つ説明",
    "chatbot.suggestion.readingGrammar": "記事の文法を説明",
    "chatbot.suggestion.readingQuiz": "この記事からクイズ作成",
    "chatbot.suggestion.readingListen": "記事を聞く",
    ...
    "chatbot.sources.title": "関連する教材",
    "chatbot.sources.recent": "最近使った内容",
    "chatbot.sources.empty": "関連する教材はまだありません。具体的に質問してみてください。",
    "chatbot.reading.current": "学習中の記事",
    "chatbot.reading.level": "レベル",
    "chatbot.reading.levelUnknown": "未確認",
    "chatbot.source.grammar": "文法",
    "chatbot.source.quiz": "クイズ",
    "chatbot.source.news": "読解",
    "chatbot.source.vocabulary": "語彙",
    "chatbot.agent.loading": "Kamiが合う教材を確認しています...",
    "chatbot.agent.toolsLoading": "Kamiが関連する語彙、文法、読解を見ています。",
    "chatbot.provider.label": "状態",
    "chatbot.provider.ready": "準備OK",
    "chatbot.provider.fallback": "基本回答",
    "chatbot.provider.none": "未開始",
    ...
    "chatbot.fallbackNote": "注: Kamiは基本モードで回答しています。短く具体的に聞くと答えやすくなります。",
    ...
    "chatbot.action.listenReading": "記事を聞く",
    "chatbot.action.saveSource": "復習に保存",
    "chatbot.action.saveArticle": "この記事を保存",
    "chatbot.action.createQuiz": "クイズ作成",
    "chatbot.action.createQuizFromArticle": "この記事からクイズ作成",
    "chatbot.action.saveShort": "保存",
    "chatbot.action.quizShort": "クイズ",
    "chatbot.action.logActivity": "履歴に保存",
    "chatbot.action.savedToHistory": "学習履歴に保存しました",
