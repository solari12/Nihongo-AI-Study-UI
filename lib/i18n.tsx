...
const dictionaries = {
  vi: {
    ...
    "chatbot.title": "Chatbot AI",
    "chatbot.description": "Study Agent dùng RAG, tiến độ học và công cụ đọc dữ liệu để tư vấn tiếng Nhật.",
    "chatbot.welcome.title": "Xin chào, mình là trợ lý học tiếng Nhật của Nihongo AI Study.",
    "chatbot.welcome.description": "Mình có thể tra cứu kho từ vựng, ngữ pháp, quiz, bài đọc và tiến độ học để trả lời kèm nguồn. Với câu hỏi về mục tiêu học, mình sẽ xem dữ liệu hiện có trước khi đề xuất kế hoạch.",
    "chatbot.now": "Bây giờ",
    ...
    "chatbot.agent.loading": "Đang xem nguồn RAG, tiến độ học và công cụ phù hợp...",
    "chatbot.agent.toolsLoading": "Agent có thể đang gọi công cụ đọc hồ sơ, tiến độ, ngữ pháp hoặc bài đọc.",
    ...
    "chatbot.saveSourceNote": "Được lưu từ Chatbot AI.",
  ...
  en: {
    ...
    "chatbot.description": "Study Agent uses RAG, learning progress, and data tools to support Japanese study.",
    "chatbot.welcome.title": "Hello, I am Nihongo AI Study's Japanese learning assistant.",
    "chatbot.welcome.description": "I can search vocabulary, grammar, quizzes, readings, and learning progress to answer with sources. For goal-related questions, I will check the available data before suggesting a plan.",
    "chatbot.now": "Now",
    ...
    "chatbot.agent.loading": "Checking RAG sources, progress, and relevant tools...",
    "chatbot.agent.toolsLoading": "The agent may be reading profile, progress, grammar, or reading data.",
    ...
    "chatbot.saveSourceNote": "Saved from AI Chatbot.",
  ...
  ja: {
    ...
    "chatbot.title": "AIチャット",
    "chatbot.description": "Study AgentはRAG、学習進捗、データツールを使って日本語学習をサポートします。",
    "chatbot.welcome.title": "こんにちは。Nihongo AI Studyの日本語学習アシスタントです。",
    "chatbot.welcome.description": "語彙、文法、クイズ、読解、学習進捗を検索して、ソース付きで回答できます。学習目標に関する質問では、利用可能なデータを確認してから計画を提案します。",
    "chatbot.now": "今",
    ...
    "chatbot.agent.loading": "RAG・学習進捗・関連ツールを確認中...",
    "chatbot.agent.toolsLoading": "プロフィール・進捗・文法・読解データを確認中です。",
    ...
    "chatbot.saveSourceNote": "AIチャットから保存しました。",
